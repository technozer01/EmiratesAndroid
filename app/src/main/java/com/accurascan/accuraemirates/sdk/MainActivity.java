...
//        String filename = getExternalFilesDir(null).getPath() + File.separator + "my_app.log";
        File file = new File(Environment.getExternalStorageDirectory(), "AccuraEmirtaes-app1.1.log");
